...
<head>
  ...
  <title>FRC 2026 Sezonu: REBUILT - FRC Rookieverse</title>
...
<body class="bg-gray-50">
  ...
  <?php require_once 'navbar.php'; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center justify-between p-8 bg-gray-100 rounded-lg shadow-inner mb-12">
                <div class="lg:w-1/2 mb-6 lg:mb-0 lg:pr-8">
                    <h1 class="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-4">REBUILT™: Yeniden İnşa Et ve Keşfet</h1>
    ...
    <section id="events" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Yaklaşan Etkinlikler</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Tüm takımları ilgilendiren global FRC takvimini takip edin.</p>
            </div>
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <div class="mt-3 sm:mt-4 flex flex-col sm:flex-row sm:items-center text-gray-600 gap-2 sm:gap-6">
                            <div class="flex items-center text-sm sm:text-base">
                                ...
                                <span><b>Tarih :</b> <b>17–19 Ekim 2025</b></span>
                            </div>
    ...
    <section id="regionals" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Türkiye Regional Turnuvaları</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Takımlarımızın Dünya Şampiyonası'na giden yolda rekabet edeceği yerel turnuvalar.</p>
            </div>
