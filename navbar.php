    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-[#E5AE32] hover:bg-gray-50" href="<?php echo BASE_URL; ?>/frc-terms.php">FRC Sözlük</a>
                ...
                <a href="<?php echo BASE_URL; ?>/<?=$_SESSION ? 'team/panel.php' : 'team-login.php'?>" class="inline-flex items-center justify-center gap-2 h-9 bg-[#E5AE32] hover:bg-[#E5AE32]/90 text-white font-semibold px-6 py-2 rounded-lg">
                    <?php
